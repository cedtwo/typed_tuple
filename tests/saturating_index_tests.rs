...
fn test_saturating_sub_with_saturation() {
    ...
    assert_eq!(<Result4 as TupleIndex>::INDEX, 0);
}
...
fn test_saturating_arithmetic_composition() {
    ...
    assert_eq!(<Step2 as TupleIndex>::INDEX, 4);
    ...
    assert_eq!(<Step4 as TupleIndex>::INDEX, 0);
    ...
    assert_eq!(<Step6 as TupleIndex>::INDEX, 5);
}
