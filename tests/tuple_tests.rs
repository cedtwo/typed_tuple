...
fn test_const_index_access() {
    ...
    let first = TypedTuple::<0, _>::get(&tuple);
    let second = TypedTuple::<1, _>::get(&tuple);
    let third = TypedTuple::<2, _>::get(&tuple);
    ...
    *TypedTuple::<0, _>::get_mut(&mut tuple) = 10u8;
    *TypedTuple::<1, _>::get_mut(&mut tuple) = 20u16;
    *TypedTuple::<2, _>::get_mut(&mut tuple) = 30u32;
