...
fn test_large_index_arithmetic() {
    ...
    assert_eq!(<Result1 as TupleIndex>::INDEX, 50);

    type Result2 = <TupleIndex63 as TupleIndexSub<TupleIndex10>>::Output;
    assert_eq!(<Result2 as TupleIndex>::INDEX, 53);
